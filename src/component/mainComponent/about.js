      ...
      <div className="card-body ">
        ...
        <div class="row g-0">
          ...
          <div class="card col-md-12 col-sm-12 col-lg-3 col-xl-3 col-xxl-3 m-3 border border-light shadow-lg rounded card-hover">
            <img src={Past} class="img-fluid rounded-end" alt="..." className='img-fluid' />
            <div class="card-body ">
          ...
          <div class="card col-md-12 col-sm-12 col-lg-3 col-xl-3 col-xxl-3 m-3 border border-light shadow-lg rounded card-hover">
            <img src={Present} class="img-fluid rounded-end" alt="..." className='img-fluid ' />
            <div class="card-body">
          ...
          <div class="card col-md-12 col-sm-12 col-lg-3 col-xl-3 col-xxl-3 m-3 border border-light shadow-lg rounded card-hover">
            <img src={Future} class="img-fluid rounded-end" alt="..." className='img-fluid' />
            <div class="card-body">
